...
router.post('/products', JwtUtil.checkToken, async function (req, res) {
    ...
    const product = { name: name, price: price, image: image, date: now, category: category };
...
router.put('/products', JwtUtil.checkToken, async function (req, res) {
    ...
    const now = new Date().getTime(); // milliseconds
    const category = await CategoryDAO.selectByID(cid);
    const product = { _id: _id, name: name, price: price, image: image, date: now, category: category };
